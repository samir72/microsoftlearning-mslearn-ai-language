...
def main():
    try:
        ...
        #client = TextTranslationClient(credential=credential, region=translatorRegion) # Use default endpoint
        client = TextTranslationClient(endpoint=endpoint, credential=credential, region=translatorRegion) # Explicitly set endpoint
